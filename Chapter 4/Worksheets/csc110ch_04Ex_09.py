# **********************************************
# WS ch4_9
# The number, e, Euler’s number, is an irrational number which has the value of 2.718281828459045 
# to that many decimals places. It is just as important as the number pi. [You can access the value of e from the math module as math.e.]
